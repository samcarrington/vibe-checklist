  ...
  return (
    <section className="relative py-3 sm:max-w-xl sm:mx-auto min-h-40" data-testid="overall-progress-section">
      <div className="relative py-3 sm:max-w-xl sm:mx-auto ">
        <h1 className="text-2xl font-semibold text-gray-700 text-center w-full pt-6">
          {title}
        </h1>
        <style jsx>{`
          .progress-indicator {
        ...
        `}</style>
        <div className="flex items-center justify-center p-5 w-40 h-40 progress-indicator">
